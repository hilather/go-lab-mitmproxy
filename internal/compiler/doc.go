...
// Compile). The returned Snapshot is immutable; callers must not mutate
// Canonical, Rules, CA, or SOCKSUsers. internal/snapshot.Store holds the
// live pointer that the proxy re-reads.
package compiler
