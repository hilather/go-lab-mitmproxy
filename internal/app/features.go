...
func CatalogFromSpec(spec model.Spec) []Feature {
	return []Feature{
		...
		},
		{
			...
			Title:       "HTTP CONNECT",
			Description: "Forward-proxy HTTP CONNECT. Disabled returns 403 before Hijack. SOCKS CONNECT is a different ID. Orig-dest tagged CONNECT stays 400.",
		...
		},
		{
			...
			Description: "Absolute-form http:// requests on the proxy listener. Disabled returns 403 before DNS. Orig-dest origin-form is not this flag. Absolute https:// stays 400.",
