...
var expectedInvalid = map[string]string{
	...
	"http-auth-enabled-no-users.yaml":             violationInvalidValue,
	"http-auth-bad-id.yaml":                       violationInvalidValue,
	"http-auth-missing-file.yaml":                 violationUnresolved,
	"proxy-authorization.yaml":                    violationUnknownField,
