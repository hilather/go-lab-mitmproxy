...
func TargetDenied(message string) *Error {
	return New(CodeTargetDenied, message)
}
...
func StoreFull(message string) *Error {
	return New(CodeStoreFull, message)
}

func StoreOverNewCap(message string) *Error {
	return New(CodeStoreOverNewCap, message)
}

func CursorStale(message string) *Error {
	return New(CodeCursorStale, message)
}

func BreakpointInactive(message string) *Error {
	return New(CodeBreakpointInactive, message)
}
