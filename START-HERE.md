...
GA / 1.0 is not done without the embedded flow-inspector UI (PR 13). LabMITM is a lab intercepting proxy, not a public MITM product and not an attack tool. 1.0 ships the appliance; lab compose-in is a follow-on (D18). Residuals: [docs/known-limitations.md](https://github.com/hilather/go-lab-mitmproxy/blob/main/docs/known-limitations.md). First candidate notes: [docs/releases/v1.0.0-rc.1.md](https://github.com/hilather/go-lab-mitmproxy/blob/main/docs/releases/v1.0.0-rc.1.md).
