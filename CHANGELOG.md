...
- QA bootstrap [examples/qa-websocket-off.yaml](https://github.com/hilather/go-lab-mitmproxy/blob/main/examples/qa-websocket-off.yaml) with `protocols.websocket.enabled: false` (fail-closed 403; `labmitm validate`).
